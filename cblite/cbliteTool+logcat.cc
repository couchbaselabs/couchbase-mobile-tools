...
const Tool::FlagSpec CBLiteTool::kLogcatFlags[] = {
    {"--csv",  (FlagHandler)&CBLiteTool::csvFlag},
    {"--full", (FlagHandler)&CBLiteTool::fullFlag},
    {"--out",  (FlagHandler)&CBLiteTool::outFlag},
    {nullptr, nullptr}
};
...
void CBLiteTool::writeLog(MultiLogDecoder &decoder, ostream &out) {
...
void CBLiteTool::writeLogCSV(MultiLogDecoder &decoder, ostream &out) {
